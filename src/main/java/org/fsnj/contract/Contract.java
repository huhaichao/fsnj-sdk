...
import org.fsnj.transaction.TxStatus;
...
public class Contract {
    ...
    private Value[] init;
    private String abi;
    private List<org.fsnj.blockchain.Contract.State> state;
    ...
    public Contract(ContractFactory factory, String code, String abi, String address, Value[] init, List<org.fsnj.blockchain.Contract.State> state) {
    ...
    public List<org.fsnj.blockchain.Contract.State> getState() {
